...
#        Given que el usuario se encuentra en la bandeja de entrada
    ...
    Scenario Outline: Filtro de solicitudes por todos los estados
        When se selecciona el estado Todas con filtro "<identificacion>", filtro "<tipo_solicitud>" y filtro "<numero>" luego se oprime el boton filtrar
        Then debe mostrar los datos que cumplen con los filtros seleccionados

        Examples:
            | identificacion              | tipo_solicitud   | numero  |
            | Todas                       | Todas            | Vacio   |
#            | Todas                       | Creacion de Cupo | Vacio   |
#            | Todas                       | Aumento de Cupo  | 13957639|
#            | C.C - Cedula de Ciudadania  | Todas            | Vacio   |
#            | C.C - Cedula de Ciudadania  | Creacion de Cupo | Vacio   |
#            | C.C - Cedula de Ciudadania  | Aumento de Cupo  | Vacio   |
#            | C.E - Cedula de Extranjeria | Todas            | Vacio   |
#            | C.E - Cedula de Extranjeria | Creacion de Cupo | Vacio   |
#            | C.E - Cedula de Extranjeria | Aumento de Cupo  | Vacio   |
